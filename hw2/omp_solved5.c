...
/* I remember this exact example (not with omp but with mutexes) from my OS
 * class. Basiocally the first section claims a, and then the second section
 * claims b, but then they're stuck. Instead, we need to release control of a
 * before we ask for b, and vice verse in the other section.
 */
