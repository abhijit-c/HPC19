...
/* It's the #pragma omp barrier at line 86 that's causing the error here. It's
 * called inside of a section block, which makes no sense as it will never be
 * able to be finished. Therefore, we just comment it out.
 */
